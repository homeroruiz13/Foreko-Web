                ...
                <div className="flex justify-center">
                  <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
                    {testimonials.map((item: any, index: number) => (
                      <div key={`founder-${index}`} className="bg-neutral-900/50 rounded-3xl p-12 border border-neutral-800 hover:border-neutral-700 transition-colors flex-1 grid grid-rows-[120px_100px_1fr_auto] gap-6">
                        ...
                        <p className="text-neutral-300 text-base leading-relaxed text-center">
                          {item.text}
                        </p>
