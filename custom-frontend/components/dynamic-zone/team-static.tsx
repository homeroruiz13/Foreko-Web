            ...
            {heading.toLowerCase().includes("founder") ? (
                ...
                <div className="flex justify-center">
                  <div className="flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
                    {testimonials.map((item: any, index: number) => (
                      <div key={`founder-${index}`} className="bg-neutral-900/50 rounded-3xl p-12 border border-neutral-800 hover:border-neutral-700 transition-colors flex-1 flex flex-col min-h-[500px]">
                        {/* Fixed height image section */}
                        <div className="flex justify-center mb-8 h-[120px]">
                          <Image
                        ...
                        {/* Fixed height name/title section */}
                        ...
                        {/* Flexible text section that grows */}
                        <p className="text-neutral-300 text-base leading-relaxed text-center flex-grow">
                          {item.text}
                        </p>

                        {/* LinkedIn button always at bottom with consistent spacing */}
              ...
              <div className="mt-16 pb-20">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {testimonials.map((item: any, index: number) => (
                    <div key={`team-${index}`} className="bg-neutral-900/50 rounded-3xl p-6 border border-neutral-800 hover:border-neutral-700 transition-colors flex flex-col min-h-[400px]">
                      {/* Fixed height image section */}
